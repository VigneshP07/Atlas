#!/bin/bash
#SBATCH -J Atlas_IN1K_train_1024_a
#SBATCH --output /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_1024_train_a.out
#SBATCH --error /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_1024_train_a.err
#SBATCH --qos=gpu4
#SBATCH --nodes=1
...
python -m torch.distributed.launch --nproc_per_node=4 --master_port=28425 main.py configs/atlas_1024_in1k_a.yaml
