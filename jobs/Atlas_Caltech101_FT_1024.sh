#!/bin/bash
#SBATCH -J Atlas_Caltech101_FT_1024
#SBATCH --output /home/others/abir_proj/codebase/Atlas/Output_Logs/atlas_caltech101_ft_1024.out
#SBATCH --error /home/others/abir_proj/codebase/Atlas/Output_Logs/atlas_caltech101_ft_1024.err
...
python main.py configs/atlas_caltech_ft_1024.yaml