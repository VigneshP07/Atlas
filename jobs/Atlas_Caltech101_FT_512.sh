#!/bin/bash
#SBATCH -J Atlas_Caltech101_FT_512
#SBATCH --output /home/others/abir_proj/codebase/Atlas/Output_Logs/atlas_caltech101_ft_512.out
#SBATCH --error /home/others/abir_proj/codebase/Atlas/Output_Logs/atlas_caltech101_ft_512.err
...
python main.py configs/atlas_caltech_ft_512.yaml