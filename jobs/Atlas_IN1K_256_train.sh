#!/bin/bash
#SBATCH -J Atlas_IN1K_train_256
#SBATCH --output /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_256_train.out
#SBATCH --error /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_256_train.err
#SBATCH --qos=gpu4
#SBATCH --nodes=1
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 --master_port=28429 main.py configs/atlas_256_in1k.yaml
