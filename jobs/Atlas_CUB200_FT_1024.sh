#!/bin/bash
#SBATCH -J Atlas_CUB200_FT_1024
#SBATCH --output /home/others/abir_proj/codebase/Atlas/Output_Logs/atlas_cub200_ft_1024.out
#SBATCH --error /home/others/abir_proj/codebase/Atlas/Output_Logs/atlas_cub200_ft_1024.err
...
torchrun \
    ...
    --master_port=39501 \
    main.py configs/atlas_cub200_ft_1024.yaml