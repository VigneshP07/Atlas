#!/bin/bash
#SBATCH -J Atlas_IN1K_train_256_b
#SBATCH --output /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_256_train_b.out
#SBATCH --error /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_256_train_b.err
#SBATCH --qos=gpu2
#SBATCH --nodes=1
...
python -m torch.distributed.launch --nproc_per_node=2 --master_port=28429 main.py configs/atlas_256_in1k_b.yaml
