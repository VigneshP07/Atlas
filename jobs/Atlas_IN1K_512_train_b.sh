#!/bin/bash
#SBATCH -J Atlas_IN1K_train_512_b
#SBATCH --output /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_512_train_b.out
#SBATCH --error /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_512_train_b.err
#SBATCH --qos=gpu2
#SBATCH --nodes=1
...
python -m torch.distributed.launch --nproc_per_node=2 --master_port=28428 main.py configs/atlas_512_in1k_b.yaml
