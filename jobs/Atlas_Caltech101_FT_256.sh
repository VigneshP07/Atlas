#!/bin/bash
#SBATCH -J Atlas_Caltech101_FT_256
#SBATCH --output /home/others/abir_proj/codebase/Atlas/Output_Logs/atlas_caltech101_ft_256.out
#SBATCH --error /home/others/abir_proj/codebase/Atlas/Output_Logs/atlas_caltech101_ft_256.err
...
python main.py configs/atlas_caltech_ft_256.yaml