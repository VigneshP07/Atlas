#!/bin/bash
#SBATCH -J Atlas_IN1K_train_512_a
#SBATCH --output /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_512_train_a.out
#SBATCH --error /raid/abircs/Vignesh_and_Indumouli_ATLAS/Codebase/Atlas/Output_Logs/atlas_in1k_512_train_a.err
#SBATCH --qos=gpu2
#SBATCH --nodes=1
...
python -m torch.distributed.launch --nproc_per_node=2 --master_port=28426 main.py configs/atlas_512_in1k_a.yaml
