#!/bin/bash
#SBATCH --job-name=atlas-dist-train        # Job name
...
#SBATCH --output=/scratch/abircs/sudipta/atlas/Output_Logs/atlas-dist-train-%j.out  # Standard output log file
#SBATCH --error=/scratch/abircs/sudipta/atlas/Output_Logs/atlas-dist-train-%j.err   # Standard error log file
...
srun torchrun \
    ...
    /scratch/abircs/sudipta/atlas/main.py /scratch/abircs/sudipta/atlas/configs/atlas_B_896.yaml
